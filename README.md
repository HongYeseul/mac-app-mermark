...
- **지우기** — 노트는 사이드바나 탭에서, 작업 공간은 폴더째, 우클릭 → 확인 창을 거쳐
  휴지통으로 보냅니다. 바로 지우지 않으므로 Finder에서 되돌릴 수 있습니다
...
| 사이드바 작업 공간 우클릭 | Finder에서 보기 · 경로 복사 · 연결 해제 · 폴더째 휴지통으로 |
...
| `trash` | 노트·작업 공간이 실제로 휴지통에 옮겨지는지와 확인 창·탭 정리 48 케이스 |
